...
- [Platform limits](platform-limits.md) — iOS-app sessions block Expo artifact creation; viewEnvVars can omit secrets that exist (check via shell); shared-proxy path collisions.
