...
const PAY_OR_QUIT_BODY = [
  ...
  "{{rent_breakdown}}",
  "",
  "The amount demanded above is RENT ONLY. No late fees, NSF charges, utility charges, EFT or convenience fees, security deposits, or other non-rent charges are included in this demand.",
  "",
  ...
  "",
  "In compliance with California Code of Civil Procedure section 1161(2), payment (certified funds only) may be made as follows:",
  "  Payable to: {{pay_to_name}}",
