...
export const BUILTIN_PRESETS: MappingPreset[] = [
  ...
  {
    // Generic "Tenant Statement" export used by many property managers. A
    // single signed Amount column (charges positive, payments negative), a
    // free-text Description ("Rent", "EFT fee", "by <tenant>", "Security
    // deposit", …) and a running Balance.
    id: "preset-tenant-statement",
    name: "Tenant Statement (PDF)",
